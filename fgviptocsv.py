...
main_grp.add_option('-o', '--output-file', help='Output csv file (default ./VIP-out.csv)', default=path.abspath(path.join(os.getcwd(), './VIP-out.csv')))
...
# -- Policy number
p_vip_name = re.compile(r'^\s*edit\s+"(?P<vip_name>.*)"$', re.IGNORECASE)
